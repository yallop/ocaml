...
and transl_structure fields cc rootpath = function
  ...
  | Tstr_value pat_expr_list ->
      let ext_fields = rev_let_bound_idents pat_expr_list @ fields in
      transl_let Nonrecursive pat_expr_list
                 (transl_structure ext_fields cc rootpath rem)
  | Tstr_value_rec pat_expr_list ->
      let ext_fields = rev_let_bound_idents pat_expr_list @ fields in
      transl_let Recursive pat_expr_list
                 (transl_structure ext_fields cc rootpath rem)
...
let rec more_idents = function
  ...
  | item :: rem ->
    ...
    | Tstr_value pat_expr_list
    | Tstr_value_rec pat_expr_list -> more_idents rem
...
let transl_store_structure glob map prims str =
  ...
  | Tstr_value pat_expr_list ->
      ...
      let lam = transl_let Nonrecursive pat_expr_list (store_idents ids) in
      Lsequence(subst_lambda subst lam,
                transl_store rootpath (add_idents false ids subst) rem)
  | Tstr_value_rec pat_expr_list ->
      let ids = let_bound_idents pat_expr_list in
      let lam = transl_let Recursive pat_expr_list (store_idents ids) in
      Lsequence(subst_lambda subst lam,
                transl_store rootpath (add_idents false ids subst) rem)
  | Tstr_primitive descr ->
      record_primitive descr.val_val;
