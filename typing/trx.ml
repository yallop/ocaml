...
let texp_case : ?guard:expression -> pattern -> expression -> case =
  fun ?guard pat exp ->
    {c_lhs=pat; c_cont=None; c_guard=guard; c_rhs=exp} (* XXX KC? *)
...
and trx_bracket_ : int -> expression -> expression = fun n exp ->
  ...
  (* rcl: regular cases; exncl: exceptional cases; effcl: effects cases *)
  | Texp_match (e,rcl,exncl,effcl,_) ->
      let cl = rcl @ exncl @ effcl in     (* handle all cases uniformly *)
      let (pl,names,binding_pat) =
        trx_cl cl (wrap_ty_in_code n (Btype.newgenvar ())) in
  ...
  | Texp_try (e,exncl,effcl) ->                 (* same as Texp_match *)
      let cl = exncl @ effcl in         (* handle all cases uniformly *)
      let (pl,names,binding_pat) =
        trx_cl cl (wrap_ty_in_code n (Btype.newgenvar ())) in
...
| Tstr_typext _
| Tstr_exception _
| Tstr_effect _ -> raise Not_modified (* XXX KC *)
...
| Texp_apply (e,el) ->
  ...
  in Texp_apply (e,el)
| Texp_match (e,cl1,cl2,cl3,p) ->
  let (e,(cl1,(cl2,cl3))) = replace_pair trx_exp (replace_pair trx_caselist (replace_pair trx_caselist trx_caselist)) (e,(cl1,(cl2, cl3)))
  in Texp_match (e,cl1,cl2,cl3,p)
| Texp_try (e,cl1,cl2) ->
  let (e,(cl1,cl2)) =
    replace_pair trx_exp (replace_pair trx_caselist trx_caselist) (e,(cl1,cl2))
  in Texp_try (e,cl1,cl2)
