...
simple_expr:
  ...
  | mod_longident DOT LPAREN seq_expr RPAREN
      { mkexp(Pexp_open(Fresh, mkmod(Pmod_ident (mkrhs $1 1)), $4)) }
  | mod_longident DOT LPAREN RPAREN
      { mkexp(Pexp_open(Fresh, mkmod(Pmod_ident (mkrhs $1 1)),
  ...
  | mod_longident DOT LBRACE record_expr RBRACE
      { let (exten, fields) = $4 in
        ...
        mkexp(Pexp_open(Fresh, mkmod(Pmod_ident (mkrhs $1 1)), rec_exp)) }
  ...
  | mod_longident DOT LBRACKETBAR expr_semi_list opt_semi BARRBRACKET
      { mkexp(Pexp_open(Fresh, mkmod(Pmod_ident (mkrhs $1 1)), mkexp(Pexp_array(List.rev $4)))) }
  | mod_longident DOT LBRACKETBAR BARRBRACKET
      { mkexp(Pexp_open(Fresh, mkmod(Pmod_ident (mkrhs $1 1)), mkexp(Pexp_array []))) }
  ...
  | mod_longident DOT LBRACKET expr_semi_list opt_semi RBRACKET
      { let list_exp = reloc_exp (mktailexp (rhs_loc 6) (List.rev $4)) in
        mkexp(Pexp_open(Fresh, mkmod(Pmod_ident (mkrhs $1 1)), list_exp)) }
  ...
  | mod_longident DOT LBRACELESS field_expr_list GREATERRBRACE
      { mkexp(Pexp_open(Fresh, mkmod(Pmod_ident (mkrhs $1 1)), mkexp (Pexp_override $4)))}
  | mod_longident DOT LBRACELESS GREATERRBRACE
      { mkexp(Pexp_open(Fresh, mkmod(Pmod_ident (mkrhs $1 1)), mkexp (Pexp_override [])))}
