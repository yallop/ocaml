...
module Exp:
  sig
    ...
    val let_and: ?loc:loc -> ?attrs:attrs -> value_binding list
              -> expression -> expression
    val let_rec: ?loc:loc -> ?attrs:attrs -> value_binding list
              -> expression -> expression
...
module Str:
  sig
    ...
    val value: ?loc:loc -> value_binding list -> structure_item
    val value_rec: ?loc:loc -> value_binding list -> structure_item
